    ...
    <div style={{width: 390, paddingTop: 4, paddingBottom: 8, left: 0, top: 773, position: 'absolute', background: 'white', borderTopLeftRadius: 16, borderTopRightRadius: 16, justifyContent: 'center', alignItems: 'flex-end', gap: 24, display: 'inline-flex'}}>
        <div style={{width: 64, alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', gap: 6, display: 'inline-flex'}}>
            <div style={{width: 28, height: 28, position: 'relative'}}>
                <div style={{width: 2.74, height: 2.73, left: 18.26, top: 18.26, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 16.19, height: 13.90, left: 10.94, top: 13.23, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 21, height: 21, left: 0.88, top: 0.88, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 0.88, height: 0.88, left: 18.81, top: 10.94, position: 'absolute', background: '#736D6D'}}></div>
            </div>
            <div style={{color: '#736D6D', fontSize: 14, fontFamily: 'Glory', fontWeight: '400', wordWrap: 'break-word'}}>Rechercher</div>
        </div>
