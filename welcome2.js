<div style={{width: '100%', height: '100%', position: 'relative', background: 'linear-gradient(180deg, #FDFAFA 0%, #FDF8F0 100%)'}}>
    <div style={{width: 390, height: 384, left: 22, top: 320, position: 'absolute'}}>
        <div style={{width: 390, height: 384, left: 0, top: 0, position: 'absolute', background: '#DDC2FF', borderRadius: 9999}} />
        <div style={{width: 299, left: 43, top: 192, position: 'absolute'}}><span style="color: '#332002', fontSize: 20, fontFamily: 'Unkempt', fontWeight: '400', wordWrap: 'break-word'">Ici, tu pourras </span><span style="color: '#332002', fontSize: 20, fontFamily: 'Unkempt', fontWeight: '700', wordWrap: 'break-word'">rechercher des pet-sitters</span><span style="color: '#332002', fontSize: 20, fontFamily: 'Unkempt', fontWeight: '400', wordWrap: 'break-word'"> et filtrer les propositions (profils vérifiés, avis, localisation, dates de garde, etc)</span></div>
    </div>
    <div style={{width: 390, paddingTop: 4, paddingBottom: 8, left: 0, top: 773, position: 'absolute', background: 'white', borderTopLeftRadius: 16, borderTopRightRadius: 16, justifyContent: 'center', alignItems: 'flex-end', gap: 24, display: 'inline-flex'}}>
        <div style={{width: 64, alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', gap: 6, display: 'inline-flex'}}>
            <div style={{width: 28, height: 28, position: 'relative'}}>
                <div style={{width: 2.74, height: 2.73, left: 18.26, top: 18.26, position: 'absolute', background: '#9609ED'}}></div>
                <div style={{width: 16.19, height: 13.90, left: 10.94, top: 13.23, position: 'absolute', background: '#9609ED'}}></div>
                <div style={{width: 21, height: 21, left: 0.88, top: 0.88, position: 'absolute', background: '#9609ED'}}></div>
                <div style={{width: 0.88, height: 0.88, left: 18.81, top: 10.94, position: 'absolute', background: '#9609ED'}}></div>
            </div>
            <div style={{color: '#9609ED', fontSize: 14, fontFamily: 'Glory', fontWeight: '600', wordWrap: 'break-word'}}>Rechercher</div>
        </div>
        ...
        <div style={{flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', display: 'inline-flex'}}>
            <div style={{width: 39, height: 39, position: 'relative', transform: 'rotate(180deg)', transformOrigin: '0 0'}}>
                <div style={{width: 26.31, height: 28.71, left: 6.35, top: 5.14, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 4.41, height: 0.91, left: 15.57, top: 28.95, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 4.34, height: 0.91, left: 19.82, top: 31.87, position: 'absolute', transform: 'rotate(-169.13deg)', transformOrigin: '0 0', background: '#736D6D'}}></div>
                <div style={{width: 1.22, height: 1.37, left: 14.97, top: 25.87, position: 'absolute', background: '#736D6D'}}></div>
                <div style={{width: 1.52, height: 1.67, left: 20.35, top: 8.74, position: 'absolute', background: '#736D6D'}}></div>
            </div>
            <div style={{width: 64, textAlign: 'center', color: '#736D6D', fontSize: 14, fontFamily: 'Glory', fontWeight: '400', wordWrap: 'break-word'}}>Mon Filoo</div>
        </div>
    ...
    <div style={{left: 79, top: 69, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 25, display: 'inline-flex'}}>
        <div style={{width: 39, height: 39, position: 'relative'}}>
            <div style={{width: 16.35, height: 14.01, left: 11.33, top: 16.58, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 14.01, height: 11.67, left: 12.50, top: 17.75, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 5.84, height: 7, left: 7.24, top: 13.08, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 3.50, height: 4.67, left: 8.41, top: 14.25, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 5.84, height: 7, left: 13.08, top: 8.41, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 3.50, height: 4.67, left: 14.25, top: 9.58, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 5.84, height: 7, left: 20.08, top: 8.41, position: 'absolute', background: '#332002'}}></div>
            <div style={{width: 3.50, height: 4.67, left: 21.25, top: 9.58, position: 'absolute', background: '#332002'}}></div>
    ...
    <div style={{width: 140, height: 140, left: 284, top: 352, position: 'absolute', transform: 'rotate(180deg)', transformOrigin: '0 0'}}>
