...
const Onboarding3 = () => {
  ...
  const topImage = require('./assets/image/onboarding3paw.png');
  const catImage = require('./assets/image/onboarding3.png');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        When you return to the kennel (or rather, the Home!), you'll find a wealth of advice and news about the animal world.        </Text>
      </View>
