...
const Onboarding5 = () => {
  ...
  const topImage = require('./assets/image/onboarding5paw.png');
  const catImage = require('./assets/image/onboarding5.png');
  ...
  const navigationIcons = {
    ...
    account: require('./assets/image/purpleaccount.png'),
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        Finally, in Account, you can complete and modify your personal information. </Text>
      </View>
