...
const Onboarding4 = () => {
  ...
  const topImage = require('./assets/image/onboarding4paw.png');
  const catImage = require('./assets/image/onboarding4.png');
  ...
  const navigationIcons = {
    ...
    pets: require('./assets/image/purplepets.png'),
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        Most important of all: your pets!</Text>
        <Text>
 
        </Text>
        <Text style={styles.description}>
        Here you can enter all the details about your pet, so that he or she can find THE pawfect pet-sitter!
        </Text>
      </View>
